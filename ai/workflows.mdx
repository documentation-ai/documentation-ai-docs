...
Workflows depend on your plan and repository connection setup. Confirm these requirements before you try to create or run a saved workflow.

<Callout kind="alert">

You need all of the following to create, edit, delete, or manually trigger saved workflows:
...
Lower plans may still be able to open the Workflows area, view workflow templates, and review run history. Saved-workflow actions such as creating, editing, deleting, or manually triggering a workflow require Standard or higher.
...
<Steps>
  <Step title="Open the Workflows page" icon="home">
  ...
  <Step title="Choose a template" icon="plus">
  ...
  <Step title="Configure the trigger" icon="play-circle">
  ...
  <Step title="Select repositories" icon="github">
  ...
  <Step title="Save and verify the workflow" icon="check-circle">
...
- A workflow notification email with a structured summary

Notification emails can include task counts, what changed, items that need review, failures, and validation issues. Use the email summary as a quick triage view, then open the run history when you need the full report, commit, or chat context.
