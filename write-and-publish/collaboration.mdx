...
---
<Image src="https://blob-cdn.documentation.ai/org-53a37986-2c9e-4094-b9e8-1e1ffae9e9ee/doc-b389b141-ae58-4fd5-91f9-6702fae9ac58/1783680069461-9q8ug1yxtu-Reamtime-collab.png?fm=auto&auto=compress%2Cformat" width="718" height="302" alt="" />
...
Real-time sync is not limited to MDX page content. Navigation changes, `documentation.json` updates, file operations such as create, delete, rename, and move, and edits to non-MDX files including JSON, OpenAPI specs, custom CSS, and scripts all sync live. Teams can coordinate both content and structural changes from the editor.

Toast notifications appear when file operations are in progress, and the publish button is disabled during active tree operations to prevent conflicts between simultaneous editors.
...
When a collaborator initiates a merge, all connected editors see the merge in progress with the initiating user's name displayed in the editor. A completion notification confirms the merge result once it finishes.
