...
- Manage documentation (write, create, edit, delete docs)

- Publish documentation

- Cannot manage team members (invite, remove, change roles)

- Cannot manage organization settings or delete the organization
...
- **Use Editor role for**: Technical writers, developers, and contributors who need to create and publish documentation but not manage team members
