...
description: >-
  Add action buttons and navigation links to your documentation site's header to
  guide users to key actions and resources.
---
...
Open your `documentation.json` file and add the navbar section. Primary button and secondary link titles render exactly as entered in `title`, including casing, in both desktop and mobile navbars.
...
2. Use the exact casing you want displayed. Button text renders exactly as written in `title`; it is not automatically capitalized.
3. Link to your primary conversion URL
4. Ensure the URL works and loads quickly
...
Include additional helpful links. Link titles also render exactly as written in `title`, including uppercase, lowercase, and title case text.
