...
By default, published documentation pages include a "Powered by Documentation.AI" footer link. You can remove this footer to present a fully branded documentation experience.

### Availability

- **Standard and Professional plans**: Available as a $25/month add-on. Purchase it from your documentation project's advanced settings in the dashboard.

- **Enterprise plan**: Included at no extra cost. Contact your customer success manager or [support](mailto:hello@documentation.ai) to enable it.

### Enable White-Label Mode

Once the add-on is active on your organization, you can toggle white-label mode for each documentation site individually from the dashboard. The change takes effect immediately on your published site without requiring a redeploy.

<Callout kind="info" collapsed="false">

  White-label mode removes the "Powered by Documentation.AI" footer from all published pages. Your content, navigation, and branding remain unchanged.
