...
---
<Update label="2026-07-10" description="Change review now correctly handles pages with SEO meta fields" tags={["fix"]}>

  ## Bug Fixes

  - **Change review with SEO meta fields**: The change review diff viewer now correctly compares pages that use `metaTitle` and `metaDescription` frontmatter fields. Previously, reviewing changes to these pages could show false differences or errors. See [Page Configuration](/customize/page-configuration).
