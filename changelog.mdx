...
---
<Update label="2026-05-04" description="AI Assistant layout controls, deployment prefix support, and clearer workflow emails" tags={["feature","improvement","fix"]}>
  ## New features

  - **AI Assistant layout controls** — Customize how the AI Assistant appears in your docs and where it sits on the page, including support for a floating layout and improved bottom spacing. Configure it in [AI Assistant](/ai/ai-assistant) and [Site Configuration](/customize/site-configuration).

  - **Storage prefix support for user-managed deployments** — Deployments now support a storage prefix so teams with custom hosting or path requirements can publish more flexibly. See [Site Configuration](/customize/site-configuration) and [Custom Subpath Setup](/customize/custom-subpath/overview).

  ## Updates

  - **Richer workflow notification emails** — Workflow emails are now easier to scan, with clearer summaries of what changed, which files were affected, and where validation or review still needs attention.

  ## Bug fixes

  - Fixed smaller formatting and reporting issues in workflow emails so summaries render more consistently and highlight validation issues more clearly.
</Update>
