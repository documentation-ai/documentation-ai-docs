...
Each end-user question costs **exactly 10 credits**, regardless of answer length or page.

For example, on the Standard plan (10,000 credits), your users can ask up to **1,000 questions per month**.
