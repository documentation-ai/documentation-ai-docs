...
Performs a hybrid search that combines semantic understanding, keyword matching, and typo tolerance. Misspelled queries can still return relevant pages when the intended terms are close enough to indexed content.
