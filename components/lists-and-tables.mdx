...
- **Insert row above/below** – Add a new row above or below the current row. "Insert row above" is not available for header rows.
...
- **Insert column left/right** – Add a new column to the left or right of the current column.
...
#### Quick add rows and columns

Hover near the bottom edge or right edge of the table to reveal a **+** button:

- **Bottom edge** – Click to add a row below the last row, or drag to add multiple rows at once.
- **Right edge** – Click to add a column to the right of the last column, or drag to add multiple columns at once.
