...
Use images to illustrate concepts, show UI, and make your documentation easier to scan. Documentation.AI serves uploaded images from the CDN and optimizes and caches standard static formats such as PNG, JPEG, WebP, SVG, and ICO. Animated GIFs are supported but served unoptimized to preserve animation behavior and improve loading reliability, so you get:

- Fast, cached delivery for supported static image formats. Animated GIFs are served unoptimized so animation playback remains reliable.
...
For most image formats, the selected image is inserted and served from the optimized CDN. Animated GIFs are inserted and served without optimization to preserve animation.
...
- **CDN:** Uploaded PNG, JPEG, WebP, SVG, ICO, and other supported static formats are optimized and cached. Animated GIFs are supported but served unoptimized to preserve animation behavior and improve loading reliability.
