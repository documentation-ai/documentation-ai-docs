...
The languages dimension translates your documentation content — pages, titles, and navigation labels. Built-in UI strings such as the feedback widget ("Was it helpful?") and its follow-up survey prompt are not currently customizable or translatable. You can enable or disable the feedback widget in Site Config under **Feedback**, but you cannot override its text.
