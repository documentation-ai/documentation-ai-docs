...
<Steps>
  ...
  <Step title="Choose a template" icon="plus" title-type="p">
    ...
    Pick the template that matches the task you want to automate. For example, choose **Style Guide Enforcement** for content checks or **Documentation Update from Code** when documentation changes depend on repository activity.
  </Step>
