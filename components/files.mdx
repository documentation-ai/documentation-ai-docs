...
Per-file size limits depend on your plan: 10 MB on Starter, 20 MB on Standard, and 30 MB on Professional and Enterprise. Audio is metered as video (20, 30, and 50 MB respectively). See [Media storage limits](/account-and-billing/usage-limits#media-storage).
