...
To attach a file, click the **paperclip icon** next to the message input, select one or more files from your device, and send your message. The Agent reads the content of attached files and uses it to produce more accurate documentation.
