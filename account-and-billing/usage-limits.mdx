...
- **Documentation Sites**: 1 documentation site
...
- **Documentation Sites**: 2 documentation sites
...
- **Documentation Sites**: 4 documentation sites
...
- **Documentation Sites**: Unlimited or custom limit
...
## Documentation Site Limits

Each documentation project with its own subdomain or custom domain counts as one documentation site.

### When You Reach Documentation Site Limits

- Cannot create new documentation projects

- Must upgrade your plan or remove an existing documentation project to create another one
...
- You need more than 10 editor seats
