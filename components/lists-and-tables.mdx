...
- **Insert row above / Insert row below** – Add a blank row immediately before or after the current row. You cannot insert above the header row.
...
To quickly append a row at the end of the table, click the **+** button that appears at the bottom edge of the table.
