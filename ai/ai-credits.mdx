...
When your monthly credit allocation isn't enough, you can add more credits in two ways:

### Add-on credit packs

Purchase a monthly credit pack from **Settings → Billing** in your dashboard. Packs are available in the following sizes and are billed as a monthly subscription:

| Pack | Credits added per month |
| ------------------ | ----------------------- |
| 5K                  | 5,000                   |
| 10K                 | 10,000                  |
| 20K                 | 20,000                  |
...
<Callout kind="info" collapsed="false">
  Credit pack pricing varies by pack size. View current prices in your dashboard under **Settings → Billing**.
</Callout>

### Overage billing

If you have an active subscription with a payment method on file, overages are billed automatically at **$0.01 per credit** when you exceed your plan's monthly allocation. Overages are metered in real time — you only pay for the extra credits you actually use.
