...
<Board>
  <BoardColumn title="Plan" icon="circle" color="5">
    <BoardCard
      title="Draft component docs"
      description="Write the first pass of a component reference page."
      icon="file-text"
      dueDate="2026-06-12"
      author="Docs team"
      createdAt="2026-06-01"
      uid="draft-component-docs"
    />
  </BoardColumn>

  <BoardColumn title="Publish" icon="check-circle" color="4">
    <BoardCard
      title="Add Board to navigation"
      description="Publish the Board reference alongside the other component pages."
      icon="columns-3"
      dueDate="2026-06-14"
      author="Docs team"
      createdAt="2026-06-02"
      uid="publish-board-navigation"
    />
  </BoardColumn>
</Board>
...
<Columns cols={2}>
  ...
  <Card title="Board" href="/components/board" icon="columns-3" horizontal={false}>
    Show Kanban-style workflows with colored columns, clickable cards, and detail dialogs.
  </Card>
...
- **Status boards and workflow columns** — Board
