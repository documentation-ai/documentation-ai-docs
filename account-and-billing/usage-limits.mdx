...
- **Documentation Sites**: 1 site per organization
...
- **Documentation Sites**: 2 sites per organization
...
- **Documentation Sites**: 4 sites per organization
...
- **Documentation Sites**: 5 sites per organization

- **Reset Period**: Based on your agreement

## Understanding Documentation Site Limits

Each plan limits the number of **documentation sites** you can create within an organization. A documentation site is a separate published documentation project with its own domain, navigation, and content.

<Callout kind="info">

There is no limit on the number of pages or posts within a single documentation site. You can create as many pages as your documentation needs.

</Callout>

### When You Reach the Site Limit

- You cannot create new documentation sites until you upgrade or remove an existing site
- Existing sites continue to work normally
- To add more sites, upgrade to a higher plan or contact sales for custom limits
