...
<Image src="https://blob-cdn.documentation.ai/UPLOAD/select-file-picker.png" width="584" height="398" alt="Select file dialog with an Upload tile and a selected PDF named transformers.pdf, with the Insert file button" caption="The Select file picker shows file names under each tile." style="width: 584px; height: auto; margin: 0 auto;" />

<Image src="https://blob-cdn.documentation.ai/UPLOAD/select-file-name-before-upload.png" width="584" height="486" alt="Select file dialog showing the File name field with the fixed .pdf extension and Cancel and Upload buttons before an upload starts" caption="Choosing a file to upload lets you rename it first. The extension stays fixed." style="width: 584px; height: auto; margin: 0 auto;" />
...
<Image src="https://blob-cdn.documentation.ai/UPLOAD/file-link-on-page.png" width="1098" height="660" alt="Web editor showing the Media tab with demonstration.pdf and, on the page, an inserted video followed by a link named demonstration" caption="An inserted file appears as a link named after the file." />
