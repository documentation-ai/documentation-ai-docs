...
Hover near the left edge of a row to reveal the row menu:

- **Insert row above** – Add a new row above the selected row.
- **Insert row below** – Add a new row below the selected row.
...
- Insert new rows between existing ones.

You can also click the **+** button at the bottom-right edge of the table to append a row at the end, or drag it to add or remove multiple rows at once.
