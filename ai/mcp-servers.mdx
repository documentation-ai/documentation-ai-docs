...
| **Access** | Read-only, published content (public or gated with authentication) | Read and write |
| **Setup** | None. The endpoint is live as soon as you publish. | Connect your client, then sign in with OAuth 2.1 |
| **Permissions** | Public content by default. Gated content requires [access control](/customize/access-control/overview) and MCP credentials. | Your Documentation.AI workspace role |
