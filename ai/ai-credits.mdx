...
If you need more credits before your next cycle resets, you can add a monthly credit pack to your subscription. Credit packs provide savings compared to paying the overage rate of $0.01 per credit:
...
You can purchase credit packs from:

- **Settings → Billing** — Click **Add credits** in the add-ons section.
- **Settings → AI Usage** — Use the credit packs section to select a pack.

If you enable optional overage billing, AI features continue working after your credits are exhausted at $0.01 per credit. Overage billing can be toggled in your billing settings.
