...
## White-Label: Remove Documentation.AI Branding

By default, your published documentation site includes a small "Powered by Documentation.AI" badge. If you need a fully white-labeled experience, you can remove this branding.

To enable white-label mode:

1. Go to **Settings → Billing** in your dashboard.
2. Toggle on **Remove Branding**.

<Callout kind="info" collapsed="false">

  White-label branding is available on qualifying plans. If you don't see the toggle, you may need to upgrade. The setting takes effect on your next deployment.
