...
<Image src="https://blob-cdn.documentation.ai/UPLOAD/select-video-picker.png" width="584" height="398" alt="Select video dialog with an Upload tile, a selected video showing its duration, the URL or embed code option, and the Insert video button" caption="The Select video picker. Choose an uploaded video, upload one, or switch to a URL or embed code." style="width: 584px; height: auto; margin: 0 auto;" />
...
<Image src="https://blob-cdn.documentation.ai/UPLOAD/video-block-in-editor.png" width="666" height="382" alt="An uploaded video in the web editor with its poster frame, size badge, and the hover toolbar for alignment, playback, and delete" caption="An uploaded video on the page, with the hover toolbar." style="width: 666px; height: auto; margin: 0 auto;" />
