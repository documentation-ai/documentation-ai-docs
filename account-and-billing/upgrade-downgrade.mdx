...
- **Excess sites** remain accessible but cannot create new ones

- **Must remove** a documentation project to create another within the new limit
...
| ---------------------- | ------- | -------- | ------------ | ---------- |
| Editor Seats           | 1       | 3        | 10           | Unlimited  |
| Documentation Sites    | 1       | 2        | 4            | Unlimited  |
