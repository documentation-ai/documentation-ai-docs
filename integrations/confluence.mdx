...
Use the Confluence integration to connect your Atlassian account and make Confluence available as an AI agent context source. The Writer and Answer agents read Confluence pages live at runtime through an AI subagent, not through an import or ETL pipeline. When a prompt needs wiki context, the agent queries Confluence on demand with CQL, then reads the relevant pages directly.
