...
When your monthly allocation runs low, you can supplement it in two ways from **Settings → Organization Settings → Billing** in your dashboard.

### Credit packs

Credit packs are monthly add-on subscriptions that increase your recurring credit allocation. Available sizes:
...
Pack credits are granted immediately upon purchase and replenish on each billing cycle. Pricing for each pack is displayed in the billing dashboard at checkout.

### Overage billing

Enable pay-as-you-go overage to continue using AI features beyond your plan and pack allocations. Overage is billed at **$0.01 per credit** and can be capped with an optional monthly USD spending limit.

Overage requires an active subscription with a payment method on file. You can enable or disable it at any time from the billing settings.
