...
1. Navigate to **Settings** → **My Account**
2. In the account profile interface, select the **Security** section
3. Click **Change password** and follow the prompts

<Callout kind="info">
  Password management is handled through your account's authentication provider. If you signed up using a social login (Google, GitHub, etc.), you may not have a separate password — manage your credentials through that provider instead.
</Callout>
...
1. Go to the Documentation.AI login page
2. Click **Forgot password?**
3. Enter your email address and follow the verification instructions sent to your inbox
