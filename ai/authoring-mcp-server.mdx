...
Your project selection persists for 7 days, so if your session drops or the server restarts, you will not need to re-select your project when reconnecting. The server re-validates your access on each reconnection to ensure your permissions are current.
