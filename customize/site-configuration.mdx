...
<Callout kind="info" collapsed="false">
  Navbar labels are not auto-capitalized. Enter the capitalization you want displayed; primary button and secondary link titles render exactly as written in `documentation.json`.
</Callout>
