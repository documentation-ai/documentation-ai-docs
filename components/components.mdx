...
<Columns cols={2}>
  ...
  <Card title="Board" href="/components/board" icon="kanban" horizontal={false}>
    ...
    Create horizontally scrolling status boards with columns, cards, colors, and detail dialogs.
...
<Board>
  <BoardColumn title="Planned" icon="circle" color="5">
    <BoardCard title="Draft reference" description="Create the component page and usage example." icon="file-text" author="Docs team" />
  </BoardColumn>

  <BoardColumn title="Published" icon="check-circle" color="4">
    <BoardCard title="Add navigation" description="Link the Board page from the component library." icon="kanban" author="Docs team" />
  </BoardColumn>
</Board>
...
- **Status boards and roadmap-style layouts** — Board
