...
<Callout kind="info" collapsed="false">
  These authentication methods protect your **published documentation site** — they are separate from your personal Documentation.AI account password. To change your account password, go to **Settings → My Account** in the dashboard.
</Callout>
