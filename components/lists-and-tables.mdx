...
- **Insert row above / Insert row below** – Add a new row above or below the current row.
...
- Insert new rows above or below an existing row.
...
- **Insert column left / Insert column right** – Add a new column to the left or right of the current column.
...
You can also click the **+** button at the bottom of the table to quickly add a new row after the last row.
