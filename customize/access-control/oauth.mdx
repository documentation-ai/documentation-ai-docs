...
<Steps>
  <Step title="Select OAuth 2.0 in the dashboard" icon="settings" title-type="p">
    In your dashboard, go to **Settings > Access Control**, select **Private** or **Partial**, then choose **OAuth 2.0** as the authentication method. OAuth 2.0 is available in both Private and Partial modes.
  </Step>
