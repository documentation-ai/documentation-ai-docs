...
- Create, edit, and publish documentation

- Create and manage branches and pull requests

- Push changes to the repository

- Modify documentation-level settings (AI assistant configuration, authentication settings)

- Request and cancel PDF exports

**Cannot:**

- Manage team members or organization settings

- Delete documentation or projects

- Manage API keys or custom domains

- Change source repository or deployment branch configuration
...
- Editors can create, edit, and publish documentation but cannot manage organization or team settings
...
- **Use Editor role for**: Technical writers, developers, and content creators who need to write and publish documentation without organization management access
...
- Use Viewer role as default. Use Editor for content creators who need to write and publish. Reserve Admin for those who need full access.
