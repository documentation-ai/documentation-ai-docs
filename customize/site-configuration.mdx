...
Complete schema for the `documentation.json`  is available at [https://dashboard.documentation.ai/documentation.json](https://dashboard.documentation.ai/documentation.json)&#x20;
...
<ParamField path="name" param-type="string" required="true" deprecated="false" show-location="true">
  Site name displayed in the browser title, navigation header, and social media
  previews.
</ParamField>

<ParamField path="initialRoute" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="template" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="logo-dark" param-type="string" required="false" deprecated="false" show-location="true">
  Main logo displayed in dark theme. Supports PNG, SVG, WEBP formats.
</ParamField>

<ParamField path="logo-light" param-type="string" required="false" deprecated="false" show-location="true">
  Main logo displayed in light theme.
</ParamField>

<ParamField path="logo-small-dark" param-type="string" required="false" deprecated="false" show-location="true">
  Small logo/favicon for dark theme. Used in browser tabs and mobile view.
</ParamField>

<ParamField path="logo-small-light" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="light" param-type="object" required="false" deprecated="false" show-location="true">
  Color scheme for light mode appearance.

  <Expandable title="Light Mode Color Options" default-open="false">
    <ParamField path="brand" param-type="string" required="false" deprecated="false" show-location="true">
      Primary brand color for buttons, links, and accents. Use hex format (e.g., `#3143e3`).
    </ParamField>

    <ParamField path="heading" param-type="string" required="false" deprecated="false" show-location="true">
      Heading and title text color. Default: `#1a1a1a`.
    </ParamField>

    <ParamField path="text" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="dark" param-type="object" required="false" deprecated="false" show-location="true">
...
<ParamField path="primary" param-type="object" required="false" deprecated="false" show-location="true">
  ...
  <Expandable title="Button Configuration" default-open="false">
    <ParamField path="title" param-type="string" required="true" deprecated="false" show-location="true">
      Text displayed on the button.
    </ParamField>

    <ParamField path="link" param-type="string" required="true" deprecated="false" show-location="true">
...
<ParamField path="links" param-type="array" required="false" deprecated="false" show-location="true">
...
<ParamField path="public" param-type="boolean" required="false" deprecated="false" show-location="true">
...
<ParamField path="products" param-type="array" required="false" deprecated="false" show-location="true">
  Organize documentation by different products or services your company offers.
</ParamField>

<ParamField path="versions" param-type="array" required="false" deprecated="false" show-location="true">
  Organize documentation by product versions or API versions.
</ParamField>

<ParamField path="languages" param-type="array" required="false" deprecated="false" show-location="true">
...
<ParamField path="product | version | language" param-type="string" required="true" deprecated="false" show-location="true">
  Display name for the dimension item shown in the selector UI.
</ParamField>

<ParamField path="icon" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="tabs" param-type="array" required="false" deprecated="false" show-location="true">
  Horizontal navigation bar for switching between parallel sections like
  "Guides" and "API Reference".
</ParamField>

<ParamField path="dropdowns" param-type="array" required="false" deprecated="false" show-location="true">
...
<ParamField path="tab" param-type="string" required="true" deprecated="false" show-location="true">
...
<ParamField path="href" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="dropdown" param-type="string" required="true" deprecated="false" show-location="true">
...
<ParamField path="description" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="group" param-type="string" required="true" deprecated="false" show-location="true">
...
<ParamField path="expandable" param-type="boolean" required="false" deprecated="false" show-location="true">
...
<ParamField path="openapi" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="hidden-apis" param-type="array" required="false" deprecated="false" show-location="true">
...
<ParamField path="pages" param-type="array" required="true" deprecated="false" show-location="true">
...
<ParamField path="path" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="method" param-type="string" required="false" deprecated="false" show-location="true">
  HTTP method for API endpoint pages (e.g., `"GET"`, `"POST"`, `"DELETE"`). Used
  for visual indicators in API documentation.
</ParamField>

<ParamField path="tags" param-type="string" required="false" deprecated="false" show-location="true">
  Categorization tags for organizing related content.
</ParamField>

<ParamField path="badge" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="show-sidebar" param-type="boolean" required="false" deprecated="false" show-location="true">
...
<ParamField path="show-toc" param-type="boolean" required="false" deprecated="false" show-location="true">
  Controls the right-side Table of Contents panel visibility on this page. Set to `false` to hide the TOC. Default: `true`.
</ParamField>

<ParamField path="show-parent-label" param-type="boolean" required="false" deprecated="false" show-location="true">
  Controls the group/parent name label that appears above the page title. Set to `false` to hide it. Default: `true`.
</ParamField>

<ParamField path="content-width" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="openapi-mode" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="integrations" param-type="object" required="false" deprecated="false" show-location="true">
...
<ParamField path="integrations.cookies" param-type="object" required="false" deprecated="false" show-location="true">
  ...
  <Expandable title="Category entry properties" default-open="false">
    <ParamField path="key" param-type="string" required="true" deprecated="false" show-location="true">
      The cookie or localStorage key to check (e.g., `CookieConsent`, `OptanonConsent`).
    </ParamField>

    <ParamField path="value" param-type="string" required="true" deprecated="false" show-location="true">
...
<ParamField path="integrations.telemetry.enabled" param-type="string" required="false" deprecated="false" show-location="true">
  Set to `"false"` to disable page view tracking. Defaults to enabled.
</ParamField>

<ParamField path="integrations.telemetry.category" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="scripts" param-type="array" required="false" deprecated="false" show-location="true">
  ...
  <Expandable title="Script entry properties" default-open="false">
    <ParamField path="src" param-type="string" required="true" deprecated="false" show-location="true">
    ...
    <ParamField path="category" param-type="string" required="false" deprecated="false" show-location="true">
...
<ParamField path="robots:index" param-type="boolean" required="false" deprecated="false" show-location="true">
  Allow search engines to index your documentation pages. Default: `true`.
</ParamField>

### Search Engine Link Following

<ParamField path="robots:follow" param-type="boolean" required="false" deprecated="false" show-location="true">
...
<ParamField path="sitemap:enabled" param-type="boolean" required="false" deprecated="false" show-location="true">
...
<ParamField path="llms-txt:enabled" param-type="boolean" required="false" deprecated="false" show-location="true">
...
Configure AI assistant retrieval behavior to control how search results are scoped across documentation dimensions.
...
<ParamField path="strict-dimensions" param-type="boolean" required="false" deprecated="false" show-location="true">
  When `true`, the AI assistant only answers from the reader's current product, version, and language. When `false` or omitted, the assistant searches across all dimensions and indicates where the answer came from. See [AI Assistant](/ai/ai-assistant#strict-dimensions) for behavioral details.
</ParamField>

<Callout kind="info" collapsed="false">
  Strict dimensions only applies to documentation projects that use [Dimensions](/organize/dimensions). If your project has no dimensions, this setting has no effect.
</Callout>
