...
description: Connect AI agents to Documentation.AI for read/write documentation workflows, authoring, review, and deployment tasks.
---
...
Use this server for authoring and documentation operations through an MCP client. If you need direct REST API access instead, use the Documentation.AI REST API. If your AI agent only needs read-only access to published content, use the [Reader MCP Server](/ai/reader-mcp-server).

</Callout>

<Callout kind="alert">

This server uses your Documentation.AI account permissions and can modify live documentation. Connect it only to AI agents and workflows you trust, and use branches when you want review before deployment.
