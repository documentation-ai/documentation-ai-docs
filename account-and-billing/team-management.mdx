...
- Delete and unpublish documentation
...
- Restructure navigation and edit page settings

- Create branches, submit pull requests, and merge branches

- Save and publish documentation changes

- Cannot manage organization members or settings

- Cannot delete or unpublish documentation
...
- **Use Editor role for**: Technical writers, developers, and contributors who need to create, edit, and publish documentation but don't need to manage the organization
