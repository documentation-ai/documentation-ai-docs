...
Learn more about the Documentation.AI MCP server, its `searchDocumentation` tool, and configuration details in the [Reader MCP Server documentation](/ai/reader-mcp-server).
