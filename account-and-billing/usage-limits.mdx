...
<Callout kind="info" collapsed="false">
  There is no limit on the number of pages you can create within a documentation site on any plan. Plans limit the number of documentation sites (projects) you can create: Starter includes 1 site, Standard includes 2, Professional includes 4, and Enterprise includes 5.
</Callout>
