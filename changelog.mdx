...
---
<Update label="2026-07-28" description="GitLab integration, hosted OpenAPI specs by URL, Reader MCP Server rename, and editor reliability fixes" tags={["feature","improvement","fix"]}>
  ## GitLab Integration
