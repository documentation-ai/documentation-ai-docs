...
<Image src="https://blob-cdn.documentation.ai/UPLOAD/select-image-picker.png" width="584" height="398" alt="Select image dialog with an Upload tile, a selected image, and the Insert image button" caption="The Select image picker. Upload a new image or pick one from the library." style="width: 584px; height: auto; margin: 0 auto;" />
