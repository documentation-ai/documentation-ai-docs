...
| **Access** | Read-only. Public content without authentication, gated content with OAuth 2.1 | Read and write |
| **Setup** | None for public sites. For access-controlled sites, connect with OAuth 2.1. | Connect your client, then sign in with OAuth 2.1 |
