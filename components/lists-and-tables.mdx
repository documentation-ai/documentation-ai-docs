...
For long, multi-step procedures, consider using the [`Steps`](/components/steps)[ component](/components/steps), which gives you more control over step titles and icons.
