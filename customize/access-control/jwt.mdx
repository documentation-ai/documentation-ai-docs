...
<Steps>
  <Step title="Select JWT in the dashboard" icon="settings" title-type="p">
    In your dashboard, go to **Settings > Access Control**, select **Private** or **Partial**, then choose **JWT** as the authentication method. JWT is available in both Private and Partial modes.
  </Step>
