...
---
<Update label="2026-05-04" description="AI assistant customization and clearer workflow updates" tags={["feature", "improvement"]}>
  ## AI assistant appearance

  Admins can now customize the Ask AI assistant style and placement from dashboard settings. Appearance settings stay with your documentation configuration, so the assistant keeps the selected style and placement after you publish or redeploy your docs.

  Learn more in [AI Assistant](/ai/ai-assistant) and the [web editor site config](/write-and-publish/web-editor#site-config) documentation.

  ## Workflow reports and notifications

  AI Documentation Agent workflow reports and emails now include clearer summaries and more specific review reasons. Teams can understand what changed faster, see why a review is needed, and move from notification to action with less context switching.

  See [AI Documentation Agent](/ai/ai-documentation-agent) for more about AI-assisted documentation workflows.
</Update>
