...
<Update label="2026-06-01" description="Agent file attachments, new editor components, search improvements, and table editor fixes" tags={["feature","improvement","fix"]}>
  ...
  The AI Documentation Agent now supports file attachments. You can attach PDFs, code files, documents, and spreadsheets directly in the agent conversation to provide additional context for documentation generation.

  ### Board Component

  A new Board component is now available for organizing content in a kanban-style layout.

  ### Fuzzy Search Enabled

  Search across your documentation now uses fuzzy matching, making it easier to find content even with typos or partial queries.

  ###

  ## Editor Improvements

  Multiple editor enhancements for a smoother authoring experience.

  ### Table of Contents Panel

  A new Table of Contents panel provides an overview of your page structure, making it easier to navigate long documents.

  ### Icon Picker & Color Picker Components

  New Icon Picker and Color Picker components are available in the editor for quickly selecting icons and colors when configuring navigation items and UI elements.

  ### Drag & Drop Rearrange

  Multiple editor components (CardGroup, Step, ParamFieldGroup, etc.) now support drag-and-drop rearranging with editable popovers and data attributes.

  ### Turn Into

  Convert blocks between different component types directly in the editor using the new "Turn Into" action.

  ### Other Editor UI Improvements

  General editor UI polish and refinements for a cleaner authoring experience.

  ### Table Editor Fixes

  Resolved issues with the table editor for more reliable table editing.
</Update>
