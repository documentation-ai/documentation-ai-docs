...
<Columns cols={2}>
  ...
  <Card title="Videos and Iframes" href="/components/videos-and-iframes" icon="video" horizontal={false}>
    Upload videos to the media library, embed YouTube, Vimeo, or Loom, or any external content via iframe.
  </Card>

  <Card title="Files" href="/components/files" icon="paperclip" horizontal={false}>
    Link PDFs, spreadsheets, archives, audio, and other downloadable files hosted on the CDN.
  </Card>
