...
---
<Update label="2026-05-09" description="AI Assistant appearance, workflows, search, metadata, MDX, and deployment improvements" tags={["feature","improvement","fix"]}>
  ## New features

  - Customize [AI Assistant](/ai/ai-assistant) appearance options to better match your documentation experience.

  - Add optional CAPTCHA protection for AI Assistant interactions to help reduce automated abuse.

  ## Updates

  - Preserve dashboard [AI Assistant](/ai/ai-assistant) settings more reliably across deployments.

  - Send clearer [Workflows](/ai/workflows) notification emails so teams can understand what changed and what needs attention.

  - Improve in-site search result navigation so readers land on the right section more consistently.

  ## Bug fixes

  - Improve non-English search highlighting for multilingual documentation.

  - Clean up metadata and social descriptions configured through [Page Configuration](/customize/page-configuration).

  - Handle escaped characters and HTML entities more reliably in [Headings and Text](/components/heading-and-text) content.

  - Reduce transient deployment failures when publishing documentation. See the [Quickstart](/getting-started/quickstart) for the standard publishing flow.
</Update>
