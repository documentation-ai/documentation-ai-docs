...
If you run low on credits before your billing cycle resets, you can purchase **credit packs** directly from **Settings → Billing** in your dashboard. Credit packs provide additional AI credits that supplement your plan's monthly allocation.

You'll also see low-credit alerts in the sidebar and dashboard when your remaining credits drop below a threshold, so you can top up before running out.
