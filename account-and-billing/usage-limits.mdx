...
- **Documentation Sites**: 5 documentation sites
...
There is no limit on the number of pages or posts within a documentation site. The site limit controls how many separate documentation projects your organization can create.
