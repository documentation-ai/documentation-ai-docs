...
<Callout kind="info" collapsed="false">
  ...
  The editor URL reflects the active branch (for example, `/editor/feature-x`). When you switch branches from the selector, the URL updates automatically, so your browser's back and forward buttons work correctly between branches. You can also bookmark or share a direct link to a specific branch's editor view.
