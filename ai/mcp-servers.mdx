...
The **Authoring MCP Server** is Documentation.AI's endpoint. Your documentation team connects to it from an AI client to edit pages alongside teammates in the web editor, manage branches, and publish changes.
