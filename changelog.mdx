...
---
<Update label="2026-05-04" description="AI controls, clearer agent reports, custom-subpath publishing, and publish reliability" tags={["feature","improvement","fix"]}>
  ## New features

  - Admins can now tune [AI Assistant](/ai/ai-assistant) appearance and placement, and enable CAPTCHA protection for assistant interactions.

  - Custom-subpath publishing has better support for docs served under paths such as `/docs` or `/help`. See [Custom Subpath Setup](/customize/custom-subpath/overview).

  ## Updates

  - Dashboard AI settings now persist through the [publishing workflow](/write-and-publish/web-editor), so published docs keep the assistant configuration you set in the dashboard.

  - [AI Documentation Agent](/ai/ai-documentation-agent) reports are easier to scan, with clearer task summaries, review notes, and email summaries.

  ## Bug fixes

  - Publishing is more resilient to temporary storage failures.
</Update>
