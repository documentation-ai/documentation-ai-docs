...
If you need more credits before your next cycle resets, you can purchase credit packs or enable overage billing from your dashboard.

### Credit packs

Credit packs are one-time purchases that add credits to your account immediately. Available pack sizes:
...
Purchase a pack from **Settings → Billing** in your dashboard. Packs are billed through Stripe. You can upgrade, change, or remove a pack at any time.

<Callout kind="info" collapsed="false">
  Credit pack pricing is displayed in the dashboard at the time of purchase. Visit **Settings → Billing** to view current rates.
</Callout>

### Overage billing

Instead of buying packs upfront, enable **overage billing** to automatically purchase additional credits when you exhaust your monthly allocation. You set a spending limit in USD to cap how much you spend on overage credits each cycle.

Enable overage billing from **Settings → Billing** in your dashboard. An active subscription is required.
