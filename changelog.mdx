...
<Update label="2026-06-30" description="SVG block rendering fixes in the editor" tags={["fix"]}>
  ...
  - **SVG Block rendering** — SVG blocks now render correctly when you upload an SVG file or select one from your media gallery. Previously, uploaded SVGs could fail to display due to URL handling issues that prevented the editor from fetching the file.
