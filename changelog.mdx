...
<Update label="2026-06-01" description="Agent file attachments, new editor components, custom CSS, search improvements, and table editor fixes" tags={["feature","improvement","fix"]}>
  ...
  Add custom stylesheets to your documentation site for component-level visual control. Upload `.css` files or reference external HTTPS stylesheets, then target specific elements using stable `dai-*` class names on 60+ components. See [Custom CSS](/customize/custom-css).
