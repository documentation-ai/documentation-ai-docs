...
Use this server for authoring and documentation operations. If your AI tool only needs read-only access to published content, use the [Docs MCP Server](/ai/docs-mcp-server).
...
Open your MCP-compatible client and add the Dashboard MCP Server using the URL in the next section.
...
Require editor or admin role. These tools make the Dashboard MCP Server the right choice for authoring, automation, and deployment workflows.
