...
Uploaded images are stored in your documentation's [media library](/write-and-publish/media-library), so you can reuse, replace, and manage them from one place.
...
<Image src="https://blob-cdn.documentation.ai/org-53a37986-2c9e-4094-b9e8-1e1ffae9e9ee/doc-b389b141-ae58-4fd5-91f9-6702fae9ac58/1788844671480-znnsf6c16d-select-image-picker.png?fm=auto&auto=compress%2Cformat" width="562" height="376" alt="Select image dialog with an Upload tile, a selected image, and the Insert image button" caption="The Select image picker. Upload a new image or pick one from the library." style="width: 562px; height: auto; margin: 0 auto;" />
...
To get a URL for an uploaded image, open the **Media** tab in the web editor, hover the image, and click **Copy URL**. See [Media library](/write-and-publish/media-library#code-editor-git) for the Git-based workflow.
