...
<Update label="2026-05-11" description="AI Workflows, branches and previews, AI Assistant customization, and platform improvements" tags={["feature","improvement","fix"]}>
  ...
  Scheduled AI runs can now automatically maintain your docs on a configurable frequency. Set it once and let your documentation stay up to date in the background. Learn more in [Workflows](/ai/workflows).
  ...
  - **AI Assistant Captcha Protection** — Added hCaptcha integration to help prevent bot abuse.
