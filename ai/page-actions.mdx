...
Download as PDF lets readers save the current page as a PDF file directly from the table of contents sidebar. The page is rendered with print-optimized styles and opens the browser's print dialog, where the reader can save or print the document.

<Callout kind="info" collapsed="false">
  Full PDF export is available on Professional and Enterprise plans. For full-site PDF exports, use the dashboard **Settings → Advanced → Exports** panel.
</Callout>
