...
In the Organize are<a href="/account-and-billing/account-management" target="_blank" rel="noopener noreferrer">a, you combin</a>e pages with groups, views, and dimensions to build a structured docs site. This guide focuses on working with pages in the Web Editor first, then covers how they are referenced in configuration and how to keep their identifiers stable.
