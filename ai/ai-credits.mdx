...
### Credits included with each plan
...
New organizations also receive **10,000 one-time trial credits** valid for 14 days, so you can try AI features before committing to a paid plan.
...
When your included monthly credits are not enough, you have two options to keep AI features running:

### Credit packs

Credit packs are **monthly add-on subscriptions** that add a fixed number of credits to your balance each cycle. Available pack sizes:

| Pack | Credits per month |
| --- | ----------------: |
| 5K | 5,000 |
| 10K | 10,000 |
| 20K | 20,000 |
...
You can add, upgrade, or remove packs at any time from **Settings → Billing** in your dashboard. Pack prices are shown during checkout. If you remove a pack, any unused credits from that pack remain available until they are depleted.

### Overage billing

Instead of (or in addition to) credit packs, you can enable **overage billing** to automatically cover credits beyond your plan and pack allocation. Overage credits are billed at **$0.01 per credit** ($1 per 100 credits).

You can set an optional **spending limit** to cap how much overage you accrue. Once the limit is reached, AI features are paused until the next cycle or until you increase the limit.

Enable overage and set a spending limit from **Settings → Billing** in your dashboard.
