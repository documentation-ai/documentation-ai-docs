...
Copy this prompt to get guidance on writing clear, effective technical documentation following industry best practices test.&#x20;
...
<Update label="2025-01-15" description="v2.0.0" tags={["Breaking Change"]}>
  ...
  **Migration guide:** Follow the [API version migration guidance](/customize/redirects-and-rewrites#api-version-migration) to update your integration.
</Update>
```
