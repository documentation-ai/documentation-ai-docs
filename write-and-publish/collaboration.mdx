...
Real-time sync is not limited to page content. Navigation changes, `documentation.json` updates, Custom CSS settings, and Scripts settings also sync live, so teams can coordinate structural and configuration changes from the editor.
...
- **Admin** role can edit content, create comments, and publish changes.
