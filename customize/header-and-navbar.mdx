...
<Callout kind="info">
Navbar labels are not auto-capitalized. The primary button title and secondary link titles appear exactly as written in `documentation.json`, so enter the capitalization you want readers to see.
</Callout>
...
<ParamField path="primary" param-type="object" required="false" showLocation="false">
  ...
  <Expandable title="Button Configuration" defaultOpen="false">
    <ParamField path="title" param-type="string" required="true" showLocation="false">
      Text displayed on the button. The label renders exactly as written, including capitalization.
    </ParamField>
...
<ParamField path="links" param-type="array" required="false" showLocation="false">
  ...
  <Expandable title="Link Configuration" defaultOpen="false">
    <ParamField path="title" param-type="string" required="true" showLocation="false">
      Display text for the link. The label renders exactly as written, including capitalization.
    </ParamField>
...
- Write the exact capitalization you want displayed in the header
