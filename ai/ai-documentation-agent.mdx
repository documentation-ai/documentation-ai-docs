...
The Agent accepts the file types listed below. Images such as `.png`, `.jpg`, `.jpeg`, `.gif`, and `.webp` are not accepted as Agent attachments.
...
- Attachments are kept for **30 days** from upload, then removed automatically.
