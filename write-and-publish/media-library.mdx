...
<Image src="https://blob-cdn.documentation.ai/UPLOAD/media-tab-hover-actions.png" width="572" height="505" alt="Media tab in the web editor with Upload media, search, and a hovered tile showing the insert, copy URL, and open actions" caption="The Media tab. Hover a tile to insert it, copy its URL, or open it." />
...
<Image src="https://blob-cdn.documentation.ai/UPLOAD/media-library-window.png" width="1224" height="444" alt="Media library window with search, Type, Size, Added, Sort, and Show controls above a grid of files" caption="The Media library window with filters, sorting, and view controls." />

Click any tile to open its detail panel.

<Image src="https://blob-cdn.documentation.ai/UPLOAD/media-detail-panel.png" width="444" height="1112" alt="Detail panel for an image showing alt text, URL with copy button, type, size, dimensions, uploader, and the Insert into page, Download, Replace file, and Delete actions" caption="The detail panel. Edit alt text, copy the URL, or insert, replace, and delete the file." style="width: 420px; height: auto; margin: 0 auto;" />
...
<Image src="https://blob-cdn.documentation.ai/UPLOAD/media-storage-settings.png" width="1668" height="700" alt="Media Storage settings page showing storage used out of the quota, per-file limits by type, and usage by documentation" caption="Media Storage in organization settings." />
