...
---
<Update label="2026-08-12" description="Increased editor seat limits across all plans" tags={["improvement"]}>
  ## Increased Editor Seat Limits

  Editor seat limits have been increased across all plans:

  - **Starter**: 1 to 5 seats
  - **Standard**: 3 to 20 seats
  - **Professional**: 10 to 20 seats

  Existing organizations automatically receive the updated limits. See [Usage Limits](/account-and-billing/usage-limits) for plan details.
</Update>
