...
The Documentation.AI REST API provides programmatic access to your documentation project through a standard REST interface. You can read pages, search content, manage branches, push file changes, manage images and files, publish deployments, and read analytics, the same operations available in the dashboard, accessible from your own scripts, CI/CD pipelines, or backend services.
...
| **Editor** | All read endpoints                                          | Push, branches, merge, deploy, and media except deletion |
