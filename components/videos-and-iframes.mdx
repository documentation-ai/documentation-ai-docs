...
The video appears in your document as a native player with a poster frame captured from the first frame at upload. Uploaded videos also count toward your organization's [storage quota](/write-and-publish/media-library#limits-and-supported-file-types).
