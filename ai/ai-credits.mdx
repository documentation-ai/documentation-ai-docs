...
|---|---|
| Starter | 0 (includes one-time 10,000-credit trial, expires after 14 days) |
| Standard | 10,000 |
| Professional | 30,000 |
| Enterprise | 50,000 |

Starter includes a one-time 10,000-credit trial pack that expires after 14 days. Paid plans receive recurring monthly credits that reset on a 30-day cycle.
...
When you exhaust your credits, the AI Documentation Agent and AI Assistant features are disabled until the next credit cycle or until you purchase additional credits.

### Credit packs

Purchase additional credit packs as a monthly subscription add-on. Available pack sizes are 5,000, 10,000, 20,000, 30,000, 50,000, and 100,000 credits. Manage packs from **Settings → Organization Settings → Billing**.

### Overage billing

Enable pay-as-you-go overage billing at **$0.01 per credit**. Overage billing requires an active subscription with a payment method, and you can cap charges with a monthly USD spending limit. Enable overage from **Settings → Organization Settings → Billing**.
