...
Search results are also scoped to the selected dimension context. When a reader is viewing v2 of a product, search only returns pages from that version, not from other versions or products.
