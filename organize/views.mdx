...
For file-based management, define tabs and dropdowns directly in `documentation.json`. This is useful for version-controlled navigation, bulk changes, and pull-request review.
