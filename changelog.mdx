...
<Update label="2026-09-08" description="Media Library, Video Upload, AI assistant reliability, reader experience fixes, and access control enforcement" tags={["feature","improvement","fix"]}>
  ...
  Upload video files directly to your documentation and embed them on any page with a native video player — no external hosting, iframe embeds, or third-party video platforms required. Videos are stored and served from your media library alongside your other assets.
  ...
  - Uploaded videos count toward your organization's storage quota and appear in the media library with type filtering
  ...
  - **Role-based access enforcement**: Role-based page restrictions are now enforced only when the setting is enabled. Password-authenticated sites no longer apply stale role mappings, and anonymous readers no longer see gated page names in the navigation.
