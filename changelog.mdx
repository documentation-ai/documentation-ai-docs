...
<Update label="2026-07-10" description="Real-time collaboration with inline comments and mentions, plan updates, and editor improvements" tags={["feature","improvement"]}>
  ...
  - **Professional plan** now includes **10 editor seats** (previously 6).

  - **Standard plan** now includes **2 documentation sites** (previously 1).

  - **Remove footer branding** is now available on the **Enterprise** plan only.

  See [Upgrade/Downgrade](/account-and-billing/upgrade-downgrade) and [Usage Limits](/account-and-billing/usage-limits) for updated plan details.
  ...
  - **Workflow templates**: Disabled workflow templates are hidden from the workflow creation UI instead of appearing grayed out.
