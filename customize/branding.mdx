...
## Control Documentation.AI branding

Organizations with the remove-branding add-on can choose whether Documentation.AI branding appears on each documentation site. This white-label control is configured per documentation site, so one site can show Documentation.AI branding while another site in the same organization hides it.

Use this setting when you need a fully branded customer-facing experience or when different documentation sites have different brand requirements.

<Callout kind="info" collapsed="false">

Changing the branding visibility for a documentation site requires access to that site's settings. Purchasing, removing, or changing the remove-branding add-on is a billing change and requires an organization admin.
