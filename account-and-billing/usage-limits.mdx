...
### Enterprise Plan ($499/month, starting)

- **Editor Seats**: 20 users (expandable)

- **AI Credits**: 50,000 per month (expandable)
...
- Require more than 600 AI answers per month

- Need multiple documentation sites
