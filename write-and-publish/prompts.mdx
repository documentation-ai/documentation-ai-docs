...
<Update label="2025-01-15" description="v2.0.0" tags={["Breaking Change"]}>
  ...
  **Migration guide:** Follow the [API versioning and deprecation policy](/api-documentation-and-playground/versioning-and-deprecation-policy) to update your integration.
</Update>
```
