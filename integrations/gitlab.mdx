...
description: Connect a GitLab project as your documentation source repository, with support for self-hosted instances, auto-deploy on push, and token management.
---
...
<Steps>
  <Step title="Open Git Settings" icon="settings">
  ...
  <Step title="Enter your project details" icon="folder">
  ...
  <Step title="Connect a self-hosted instance" icon="cloud">
  ...
  <Step title="Connect and verify" icon="check-circle">
...
<Steps>
  ...
  <Step title="Update the token" icon="edit">
...
Move an existing documentation source repository from GitHub to GitLab by exporting the current source and reconnecting it.

<Steps>
  <Step title="Download your documentation" icon="download">

  In **Git Settings**, download your documentation source as a zip file. This export works for both GitHub and GitLab-backed repositories.

  </Step>
  <Step title="Push to a new GitLab project" icon="upload">

  Unzip the archive, create a new GitLab project, and push the files to that repository.

  </Step>
  <Step title="Connect the GitLab project" icon="arrow-right">

  Return to **Git Settings**, switch the provider to **GitLab**, and connect the new project.
...
<Steps>
  ...
  <Step title="Disconnect" icon="x-circle">
...
<ExpandableGroup>
  <Expandable title="Webhook not registered">
  ...
  <Expandable title="Token expired or rejected">
  ...
  <Expandable title="Cannot find Project ID">
  ...
  <Expandable title="Self-hosted GitLab not connecting">
